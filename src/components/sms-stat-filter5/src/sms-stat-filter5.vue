                ...
                <el-col :span="24">
                    <el-form-item label="科目:">
                        <el-radio-group v-model="filters.subjectid" class="inline table-view">
                            <el-radio size="small" label="TOTAL">总分</el-radio>
            ...
            <el-row>
                <el-col :span="18">
                    <el-form-item label="类型:">
                        <el-radio-group v-model="filters.showmode" class="inline">
                            <el-radio size="small" label="0">精简型</el-radio>
                            <el-radio size="small" label="1">标准型</el-radio>
                        </el-radio-group>
                        <el-button size="small" type="search" @click="onSearch" style="margin-left:25px;" :disabled="filters.classids.length==0">查询</el-button>
                        <el-button size="small" @click="onExport" :loading="exporting" :disabled="filters.classids.length==0">导出</el-button>
                    </el-form-item>
                </el-col>
            </el-row>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            onAction(message) {
                ...
                let subjectname = '';
                if (this.filters.subjectid == 'TOTAL') {
                    subjectname = '总分';
                } else {
                ...
                this.$emit(message, this.filters.termid, this.filters.examtypeid, this.filters.examid, examname, this.filters.gradeid, gradename, this.filters.classids.filter(item=>item!=''), this.classes, this.filters.subjectid, subjectname, this.filters.showmode);
            }
        },
        created() {
