        ...
        <el-row>
            <el-col :span="24" style="position: relative;">
                ...
                <el-form-item label="科目:" class="table-view">
                    ...
                    <div class="inlineb">
                        <el-button size="small" type="primary" @click="onSearch" :disabled="!filters.total && filters.checkedsubjects.length === 0" :loading="loading">查询</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            onAction(message) {
                ...
                this.$emit(message, this.filters.termid, this.filters.examtypeid, this.filters.examidname.split(':')[0], this.filters.examidname.split(':')[1], this.filters.gradeidname.split(':')[0], this.filters.gradeidname.split(':')[1], this.filters.total, this.filters.checkedsubjects);
            }
        },
        created() {
