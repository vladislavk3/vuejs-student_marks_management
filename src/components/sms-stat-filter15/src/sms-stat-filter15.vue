            ...
            <el-col :span="18">
                <el-form-item label="类型:">
                    <el-radio-group v-model="filters.showmode" class="inline">
                        <el-radio size="small" label="0">按科目</el-radio>
                        <el-radio size="small" label="1">按班级</el-radio>
                    </el-radio-group>
    ...
    export default {
        ...
        methods: {
            ...
            onAction(message) {
                ...
                this.$emit(message, this.filters.termid, this.filters.examtypeid, this.filters.examidname.split(':')[0], this.filters.examidname.split(':')[1], this.filters.gradeidname.split(':')[0], this.filters.gradeidname.split(':')[1], this.filters.classids.filter(item=>item!=''), this.classes, this.filters.total, this.filters.checkedsubjects, this.filters.showmode);
            }
        },
        created() {
